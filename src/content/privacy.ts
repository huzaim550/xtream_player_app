...
export const PRIVACY_SECTIONS: PolicySection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Live TV works slightly differently, in one way worth stating. The channel list, the programme guide and the video itself all come from your server as usual — but each channel may carry a logo image hosted somewhere else entirely, because that address is written into the channel list your server was given. When the Live TV screen shows such a logo, your device fetches that image directly from whoever hosts it, and that host sees your IP address. It is told nothing else: not which channel it was for, not your username, and nothing about what you watch.',
